  ...
  return (
    ...
    >
      ...
      <div className='mt-[4.7rem] flex overflow-hidden md:mt-0'>
        {/* BEGIN: Side Menu */}
        <nav className='side-nav z-10 hidden overflow-x-hidden px-5 pb-16 md:block md:w-[100px] xl:w-[250px]'>
          <Link href='/' className='intro-x mt-3 flex items-center pl-5 pt-4'>
            ...
            <span className='ml-3 hidden text-lg text-white xl:block'>Tinker</span>
          </Link>
