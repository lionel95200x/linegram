      ...
      <div className='top-bar-boxed relative z-[51] -mx-5 mb-12 mt-12 h-[70px] border-b border-white/[0.08] px-3 sm:-mx-8 sm:px-8 md:-mt-5 md:pt-0'>
        <div className='flex h-full items-center'>
          ...
          <Link href='/' className='-intro-x hidden md:flex'>
            <Image alt='Icewall Tailwind HTML Admin Template' className='w-6' src={logoUrl} />
              ...
              <div className='absolute right-0 z-10 mt-[3px]'>
                <div className='box w-[450px] p-5'>
                    ...
                    {_.take(fakerData, 4).map((faker, fakerKey) => (
                      <a key={fakerKey} href='' className='mt-2 flex items-center'>
                        <div className='image-fit h-8 w-8'>
                          <img alt='Linegram - Agent appel IA' className='rounded-full' src={faker.photos[0]} />
                        </div>
                  ...
                  {_.take(fakerData, 4).map((faker, fakerKey) => (
                    <a key={fakerKey} href='' className='mt-2 flex items-center'>
                      <div className='image-fit h-8 w-8'>
                        <img alt='Linegram - Agent appel IA' className='rounded-full' src={faker.images[0]} />
                      </div>
