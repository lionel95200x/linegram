    ...
    <div className='mx-auto bg-white px-4 py-16 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8 lg:py-20'>
      <div className='row-gap-10 grid gap-5 lg:grid-cols-2'>
        <div className='flex flex-col justify-center'>
          <div className='mb-6 max-w-xl'>
            <h2 className='mb-6 max-w-lg font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none'>
              ...
              <span className='relative px-1'>
                ...
                <span className='text-deep-purple-accent-400 relative inline-block'>a lazy dog</span>
              </span>
            </h2>
          ...
          <p className='mb-4 text-sm font-bold uppercase tracking-widest'>Features</p>
          <div className='grid space-y-3 sm:grid-cols-2 sm:gap-2 sm:space-y-0'>
            <ul className='space-y-3'>
              <li className='flex'>
                <span className='mr-1'>
                  <svg className='text-deep-purple-accent-400 mt-px h-5 w-5' stroke='currentColor' viewBox='0 0 52 52'>
                    <polygon
                      strokeWidth='4'
                      strokeLinecap='round'
