      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid grid-cols-2 gap-3 gap-y-8 py-10 max-sm:mx-auto max-sm:max-w-sm sm:grid-cols-4 md:gap-8 lg:grid-cols-6'>
          ...
          <div className='text-left lg:mx-auto '>
            <h4 className='mb-7 text-lg font-medium text-gray-900'>Linegram</h4>
            <ul className='text-sm  transition-all duration-500'>
              <li className='mb-6'>
                <a href={routes.home} className='text-gray-600 hover:text-gray-900'>
                  Accueil
                </a>
              </li>
              <li className='mb-6'>
          ...
          <div className='text-left lg:mx-auto '>
            ...
            <ul className='text-sm  transition-all duration-500'>
              <li className='mb-6'>
                <a href={routes.policy} className='text-gray-600 hover:text-gray-900'>
