      ...
      <div className='mt-5 grid grid-cols-11 gap-x-6 pb-20'>
        ...
        <div className='intro-y col-span-11 2xl:col-span-9'>
                ...
                <FormInline className='mt-5 flex-col items-start pt-5 first:mt-0 first:pt-0 xl:flex-row'>
                  ...
                  <div className='mt-3 w-full flex-1 xl:mt-0'>
                    <Button variant='outline-secondary' className='w-40'>
                      <Lucide icon='Plus' className='mr-2 h-4 w-4' /> Add Video URL
                    </Button>
                  </div>
                </FormInline>
              </div>
          ...
          <div className='intro-y box mt-5 p-5'>
            <div className='rounded-md border border-slate-200/60 p-5 dark:border-darkmode-400'>
              <div className='flex items-center border-b border-slate-200/60 pb-5 text-base font-medium dark:border-darkmode-400'>
                <Lucide icon='ChevronDown' className='mr-2 h-4 w-4' /> Product Variant
              </div>
              <div className='mt-5'>
                <FormInline className='mt-5 flex-col items-start pt-5 first:mt-0 first:pt-0 xl:flex-row'>
                  ...
                  <div className='mt-3 w-full flex-1 xl:mt-0 xl:text-right'>
                    <Button variant='primary' className='w-44'>
                      <Lucide icon='Plus' className='mr-2 h-4 w-4' /> Add Variant
                    </Button>
                  </div>
                </FormInline>
              </div>
