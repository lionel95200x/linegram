      ...
      <div className='w-full'>
        <nav className='fixed w-full border-b border-indigo-200 px-12 py-5 xl:px-20'>
          <div className='flex items-center justify-between'>
            {/* Website Logo */}
            <a href='#' className='flex items-center pr-7 md:pr-10'>
              <svg xmlns='http://www.w3.org/2000/svg' width={164} height={33} viewBox='0 0 164 33' fill='none'>
                ...
                <path
                  ...
                  fill='url(#paint0_linear_11721_589)'
                />
                <path
                  fillRule='evenodd'
                  clipRule='evenodd'
                  ...
                  fill='url(#paint1_linear_11721_589)'
                />
                <defs>
                  <linearGradient
                    id='paint0_linear_11721_589'
                    x1={35}
                    y1='1.89063'
                    x2='1.11152'
                    y2='33.4573'
            ...
            <div className='hidden items-center lg:flex'>
              <li className='list-none pr-6'>
                <a
                  href='#'
                  className='px-3 text-base font-medium leading-6 text-gray-900 transition-all duration-700 hover:text-gray-600'
                  aria-current='page'
                >
                  Home
                </a>
              ...
              <li className='flex items-center justify-center gap-2 pr-6'>
                ...
                <svg xmlns='http://www.w3.org/2000/svg' width={16} height={16} viewBox='0 0 16 16' fill='none'>
                  <path
                    d='M4 6L6.58579 8.58579C7.25245 9.25245 7.58579 9.58579 8 9.58579C8.41421 9.58579 8.74755 9.25245 9.41421 8.58579L12 6'
                    stroke='#6B7280'
                    strokeWidth='1.6'
                    strokeLinecap='round'
            ...
            <div className='hidden items-center gap-5 lg:flex'>
              <button className='flex h-11 w-24 cursor-pointer items-center justify-center rounded-full bg-white text-sm font-semibold leading-snug text-gray-900 duration-500 ease-in-out hover:bg-gray-100'>
                {' '}
                Login{' '}
              </button>
              <button className='flex h-11 w-24 cursor-pointer items-center justify-center rounded-full bg-gray-900 text-sm font-semibold leading-snug text-white shadow duration-500 ease-in-out hover:bg-gray-800 '>
                {' '}
                Sign up{' '}
              </button>
            </div>
          ...
          <div className='mobile-menu hidden'>
            <ul className='mt-2.5 grid items-center justify-center'>
              <li className='pr-6'>
                <a href='#' className='px-3 text-base font-medium leading-relaxed text-gray-500' aria-current='page'>
                  Home
                </a>
              </li>
              <li className='pr-6'>
                <a href='#' className='px-3 text-base font-medium leading-relaxed text-gray-500'>
                  About us
                </a>
              </li>
              <li>
                <span className='flex' id='dropdown'>
                  <button className='dropbtn flex items-center gap-2 px-3 text-base font-medium leading-relaxed text-gray-500'>
                    Products{' '}
                    <svg xmlns='http://www.w3.org/2000/svg' width={16} height={16} viewBox='0 0 16 16' fill='none'>
                      <path
                        d='M4 6L6.58579 8.58579C7.25245 9.25245 7.58579 9.58579 8 9.58579C8.41421 9.58579 8.74755 9.25245 9.41421 8.58579L12 6'
        ...
        <div
          ...
          style={{
            backgroundImage: 'url("https://pagedone.io/asset/uploads/1702271852.png")',
          }}
        >
          ...
          <p className='px-4 text-center text-lg font-normal leading-8 text-gray-900'>
            {' '}
            We're here to help! Reach us by phone at [contact number] or email us at [email address] for any queries or
            concerns.{' '}
          </p>
        </div>
            ...
            <div className='flex w-full flex-col gap-8 md:flex-row'>
              <div className='w-full md:max-w-[176px] md:border-r md:border-gray-200'>
                <ul className='tab-nav flex flex-col items-center gap-6 md:items-start lg:gap-10'>
                  <li>
                    <a href='#' className='text-base font-medium leading-7 text-indigo-600'>
                      Terms of Use
                    </a>
                  </li>
                  <li>
                    <a href='#' className='text-base font-medium leading-7 text-gray-500 hover:text-indigo-600'>
                      Privacy Policy
                    </a>
                  </li>
                  <li>
              ...
              <div className='tab-pane w-full max-md:px-4'>
                <h2 className='font-manrope mb-5 text-3xl font-bold text-gray-900 lg:text-4xl'>Terms of Use</h2>
                <div className='mb-8 flex items-center gap-3 lg:mb-10'>
                  ...
                  <p className='text-xl font-medium leading-8 text-indigo-600'>Last updated: May 26, 2023</p>
                </div>
                <p className='mb-8 text-lg font-normal leading-8 text-gray-500 lg:mb-10'>
                  {' '}
                  These are terms and conditions (the “Terms”) on which we supply products to you including digital
                  content and services. Please read these Terms carefully before you access our digital content or use
                  our services. These Terms together with our referenced Privacy Policy and Cookies Policy detail how we
                  will provide digital content and/or services to you, how you and we may change or end the contract,
                  what do in the event of a problem and other important information. <br />
                  <br /> Who we are - We are Pagedone. <br />
                  <br /> How to contact us - You can contact us by telephoning our customer service team at [contact
                  number] or by writing to us [email address].
                </p>
                <h5 className='font-manrope mb-4 text-2xl font-bold text-gray-900 md:text-3xl'>Contents</h5>
                <ul className='mb-8 ml-8 lg:mb-10'>
                  <li className='list-decimal text-lg font-normal text-gray-500'>
                    <a href='#01'>
                      Your Agreement to these Terms through Your Access of the Site or Your Use of the Site.
                    </a>
                  </li>
                  <li className='list-decimal text-lg font-normal text-gray-500'>
                  ...
                  <li className='list-decimal text-lg font-normal text-gray-500'>
                    <a href='#03'>agedone Does Not Offer and Does Not Provide Legal Advice</a>
                  </li>
                  <li className='list-decimal text-lg font-normal text-gray-500'>
                    <a href='#04'>Pagedone is Not a Law Firm. Pagedone is not offering legal representation</a>
                  </li>
                  <li className='list-decimal text-lg font-normal text-gray-500'>
                  ...
                  <li className='list-decimal text-lg font-normal text-gray-500'>
                    <a href='#06'>
                      There is No Attorney-Client relationship between You and Pagedone and You Agree that You
                    </a>
                  </li>
                  <li className='list-decimal text-lg font-normal text-gray-500'>
                  ...
                  <li className='list-decimal text-lg font-normal text-gray-500'>
                    <a href='#09'>
                      There Is No Fee to Pagedone for Finding EngagementsThere Is No Fee to Pagedone for Finding
                      Engagements
                    </a>
                  </li>
                  <li className='list-decimal text-lg font-normal text-gray-500'>
                  ...
                  <li className='list-decimal text-lg font-normal text-gray-500'>
                    <a href='#25'>
                      Limitation of Liability. Pagedone provides the Site and the Service “as is”, without warranty of
                      any kind
                    </a>
                  </li>
                  <li className='list-decimal text-lg font-normal text-gray-500'>
                ...
                <ul className='font-manrope ml-8 flex list-outside list-decimal flex-col gap-10 text-3xl font-bold'>
                  <li className='list-decimal'>
                    ...
                    <p className='mt-5 text-lg font-normal leading-8 text-gray-500'>
                      {' '}
                      These Terms govern your use of the Site, both as a visitor and as a registered user (each visitor
                      and each registered user is referred to generally for purposes of these Terms as a "Client User").
                      BY USING THE SITE, AND/OR BY REGISTERING WITH US, YOU AGREE TO THESE TERMS OF USE, You consent to
                      the information practices disclosed in our Privacy Policy and our Cookies Policy which are
                      incorporated herein by reference, and that you consent to resolve in the State of New York
                      pursuant to the terms set forth herein any dispute that you may have with us, or the Site. Please
                      note that we offer the Site "AS IS" and without warranties. If you are registering an account or
                      using the Site on behalf of an individual or entity other than yourself, you represent that you
                      are authorized by such individual or entity to accept these Terms on such individual's or entity's
                      behalf.{' '}
                    </p>
                  </li>
                  <li className='list-decimal'>
                    <h2 className='font-manrope text-2xl font-bold text-gray-900 lg:text-3xl'>Content and Services</h2>
                    <p className='mt-5 text-lg font-normal leading-8 text-gray-500'>
                      {' '}
                      Everything we offer on and through the Site is referred to in these Terms collectively as the
                      "Services". <br />
                      <br /> Some of what is on the Site is viewable without registering with us, but to actively
                      participate or store your information, you must register as a member and authorize the use and
                      disclosure of your personal and legal information pursuant to the terms of our Privacy Policy for
                      purposes of allowing us to provide the Services and as otherwise disclosed in our Privacy Policy
                      available at{' '}
                      <span className='cursor-pointer underline underline-offset-4'>
                        {' '}
                        www.pagedone.io/disclaimers-privacy.{' '}
                      </span>{' '}
                      Pagedone is an online platform that connects legal professionals ("Attorney Users") with potential
                      Client Users seeking legal services. Pagedone itself does not provide legal advice and does not
                      provide legal services of any nature whatsoever. And Pagedone does not guarantee that Client Users
                      will find legal representation through its system. Pagedone offers no opinion nor does it take a
                      position on when or if an attorney-client relationship has been formed between its Client Users
                      and Attorney Users. Pagedone is not a party to the agreements between Client Users and Attorney
                      Users governing the attorney-client relationship nor is Pagedone involved in the actual
                      representation of clients. As a result, Pagedone cannot ensure the completion of agreements
                      between the Client User and Attorney User, the accuracy or completeness of the work-product of the
                      Attorney User, or the integrity of either party. The Client User is responsible for evaluating the
                      integrity and abilities of all Attorney Users with whom the Client User communicates using the
                      Site. You acknowledge that although some of the content, text, data, graphics, images,
                      information, suggestions, guidance, and other material (collectively, "Information") that is
                      provided to you on the Site (including Information provided in direct response to your questions
                      or postings) may be provided by individuals in the legal profession, the provision of such
                      Information does not create an attorney-client relationship and does not constitute an opinion or
                      legal advice, but is provided to assist you with locating an appropriate legal professional. Any
                      form of use of the Site by potential clients or subscribing Attorney Users is not intended to and
                      will not create an attorney-client relationship between or among any person, entity, and Pagedone.
                      Any electronic communication sent to anyone at Pagedone other than an Attorney User will not
                      create an attorney-client relationship between the Client User and Pagedone.
                    </p>
                  </li>
                  <li className='list-decimal'>
                    <h2 className='font-manrope text-2xl font-bold text-gray-900 lg:text-3xl'>
                    ...
                    <p className='mt-5 text-lg font-normal leading-8 text-gray-500'>
                      {' '}
                      The information that you receive from Pagedone, and its affiliates is for informational and
                      scheduling purposes only. Pagedone is not a design firm nor does it offer you design advice,
                      recommendations, consultations or any kind of counseling. Pagedone makes its Designers available
                      to you and any information provided to you by Pagedone (other than through a Designer that you
                      hire to work with you) is (i) provided by independent design professionals and organizations
                      representing the interests of Pagedone, (ii) is for informational purposes only, and (iii) does
                      not establish any designer-client relationship between you and Pagedone.{' '}
                    </p>
                  </li>
                </ul>
        ...
        <footer className='w-full bg-gray-900'>
          <div className=' px-12 xl:px-20'>
            {/*Grid*/}
            <div className='grid grid-cols-2 gap-12 pb-20 pt-14 lg:grid-cols-4 lg:gap-8'>
              <div className='block'>
            ...
            <div className='border-t border-gray-700 py-7 '>
              <div className='flex flex-col items-center justify-center space-y-8 lg:flex-row lg:justify-between lg:space-y-0'>
                <a href='#' className='flex justify-center '>
                  <svg className='h-8 w-40' viewBox='0 0 164 33' fill='none' xmlns='http://www.w3.org/2000/svg'>
                    <path
                      d='M47 24.7231V7H54.4171C54.5916 7 54.816 7.00821 55.0903 7.02462C55.3645 7.03282 55.618 7.05744 55.8507 7.09846C56.8895 7.25436 57.7455 7.59487 58.4186 8.12C59.1001 8.64513 59.6029 9.30974 59.927 10.1138C60.2594 10.9097 60.4256 11.7959 60.4256 12.7723C60.4256 13.7405 60.2594 14.6267 59.927 15.4308C59.5945 16.2267 59.0876 16.8872 58.4061 17.4123C57.733 17.9374 56.8812 18.2779 55.8507 18.4338C55.618 18.4667 55.3604 18.4913 55.0778 18.5077C54.8035 18.5241 54.5833 18.5323 54.4171 18.5323H50.0042V24.7231H47ZM50.0042 15.7631H54.2925C54.4587 15.7631 54.6457 15.7549 54.8534 15.7385C55.0612 15.7221 55.2523 15.6892 55.4268 15.64C55.9255 15.5169 56.3161 15.2995 56.5986 14.9877C56.8895 14.6759 57.0931 14.3231 57.2094 13.9292C57.3341 13.5354 57.3964 13.1497 57.3964 12.7723C57.3964 12.3949 57.3341 12.0092 57.2094 11.6154C57.0931 11.2133 56.8895 10.8564 56.5986 10.5446C56.3161 10.2328 55.9255 10.0154 55.4268 9.89231C55.2523 9.84308 55.0612 9.81436 54.8534 9.80615C54.6457 9.78974 54.4587 9.78154 54.2925 9.78154H50.0042V15.7631Z'
                      fill='white'
                    />
                ...
                <span className='block  text-gray-400'>©pagedone 2024, All rights reserved.</span>
